...
//        text += "✔ характеристики и полный ассортимент см. на официальном сайте iSPARK\uD83D\uDD25<br>";
        text += "✔ оригинал, спецификация/оператор " + country + "/" + GadgetConst
                .MAP_COUNTRIES_OPERATOR.get(country) + ", активированы, " +
                "в наличие также имеются модели Unlocked и Ростест<br>";
